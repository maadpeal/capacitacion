...
class Decorator100 implements BilleteraInterface
{
    private $decorator;
    private $billetes;
    ...
    public function __construct($decorator50, $mostrar)
    {
        $this->decorator = $decorator50;
    ...
    public function mostrarEstadistica($monto)
    {
        if($monto === 100)
        {
            ...
            if(isset($this->billetesSacados))
            {
                ...
                return 'El monto sacado fue ' . array_sum($total) . "\n".
